...
\index{MoteReading@{MoteReading}!getSeq@{getSeq}}
\index{getSeq@{getSeq}!MoteReading@{MoteReading}}
\subsubsection[{getSeq}]{\setlength{\rightskip}{0pt plus 5cm}int MoteReading::getSeq ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\begin{center}
\leavevmode
\includegraphics[width=148pt]{classMoteReading_a7164d52474f2541952d44926cc79671d_icgraph}
\end{center}
\end{figure}
...
\begin{DoxyCode}
83 { return QString("%1 %2 %2 %4 %5 %6 %7 %8").arg(mgx).arg(mgy).arg(accx).arg(accy)
